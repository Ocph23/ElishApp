...
public partial class PembayaranDialogView : ContentPage
{
	...
	public double Sisa
	{
		get { return sisa; }
		set { sisa = value;
			var vm = BindingContext as PembayaranDialogViewModel;
			vm.SetSisa(value);
			OnPropertyChanged();
		}
	}
	...
	public PembayaranDialogView(PembayaranDialogViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
	}
...
public partial class PembayaranDialogViewModel:ObservableObject
{
    ...
    public PembayaranDialogViewModel()
    {
    ...
    private async Task BayarCommandAction()
    {
		try
		{
            ...
            WeakReferenceMessenger.Default.Send(new PembayaranPenjualanChangeMessage(new PembayaranPenjualan {
